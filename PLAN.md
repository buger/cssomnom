...
- [x] Node 24: `node --test tests/mcdc-parser-still-hot-unique-cause.test.ts` — 29 pass. Together with existing parser branch/leftover files 97 pass. `tsc --noEmit` clean. oxlint 0 warnings. Writeup: `/tmp/grok-goal-47e8a9f6b740/implementer/mcdc-parser3.md`.
