...
- [x] Node 24: `node --test tests/mcdc-serializer-still-hot-unique-cause.test.ts` — 15 pass. Together with existing serializer hotspot/tokenizer-serializer/unique-cause files 76 pass. `tsc --noEmit` clean. oxlint 0 warnings.
