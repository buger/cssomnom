...
// reqproof:proptest:skip expected-red known-issue tripwire asserting a live bug reproduces; no correct-behavior oracle exists by design (proof.yaml ki tripwire lanes)
